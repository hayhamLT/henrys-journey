...
export const TUTORIAL_LEVELS: Level[] = [
  // 1. Intro to Movement (Round Trip) - Gem is 2 cells away
  {
    ...
    tutorial: [
      ...
      { text: "Get COIN", trigger: 'add_move', highlightedMove: Move.Right },
  ...
  // 3. Collection (Multi Gem)
  {
    ...
    tutorial: [
      { text: "Get ALL COINS", trigger: 'start', highlightedMove: Move.Right },
  ...
  // 4. Hazards (Holes) - Return Path Fix
  {
    ...
    tutorial: [
      ...
      { text: "Tap RIGHT", trigger: 'add_move', highlightedMove: Move.Right },
      { text: "Up to COIN", trigger: 'add_move', highlightedMove: Move.Up },
